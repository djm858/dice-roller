 ...
 * necessary to generate a random seed near the beginning of the main function.
 * If not, the program will roll the exact same numbers each time the program
 * runs. This method below generates a seed based on the current nanosecond of
 * the host computer. It also factors in the process ID of the program running
